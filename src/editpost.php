...
if (isset($_POST["Submit"])) {
    ...
    if (empty($postTitle)) {
        ...
        //Should not redirect - because when the submit button is activated and editpost.php is loaded
        //then S_GET["edit"] fails as this url link doesnot exist and there will be undefined variable in all form fields
        /*redirect_To ("editpost.php"); //Created a function for header redirects - See Function file
        exit;*/
        ...
        $updateQuery = "UPDATE admin_panel SET datetime = '$dateTime', title = '$postTitle', category = '$postCategory', author = '$author', image = '$image', post = '$postText' WHERE id = '$editIdFromUrl'"; 
        ...
        <section>
            <div class="container-fluid">
                <div class="row">
                    ...
                    <!-- Add New Post Area-->
                    <div class="col-sm-10">
                        <h1 class="text-center py-3 text-info">EDIT POST</h1>
                        ...
                        <div>
                            <?php 
                                ...
                                $searchParameterFromURL = $_GET["edit"];
                            ...
                            -->    
                            <form action="editpost.php?edit=<?php echo $searchParameterFromURL; ?>" method="POST" enctype="multipart/form-data" class="px-5 pb-5">
                                <div class="form-group">
                                    <label for="titleText" class="text-warning">Update Title:</label>
                                    <input value = "<?php echo $titleToBeUpdated; ?>" class="form-control" type="text" name="Title" id="titleText" placeholder="Title" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="Post" id="posttext" rows="5" required><?php echo $postToBeUpdated;?></textarea>
                                </div>
                                <div class="form-group">
